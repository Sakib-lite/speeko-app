...
if(email)dispatch(sendInvitation({email}))
  ...
  return (
    <div >
      ...
      >
        <Fade in={open}>
          <Box sx={style} className="bg-gradient-to-r from-cyan-300 to-blue-300 rounded-lg">
      <form onSubmit={submitHandler}>      <Typography id='transition-modal-title' variant='h6' component='h2' className='text-gray-800'>
              Invite your friends
            </Typography>
            ...
            <div className='w-full'>
              ...
              <Button  type='submit' className='text-gray-200 bg-gray-600   hover:bg-gray-500 hover:text-gray-100 ml-auto mt-4 '>
                Send Invitation
              </Button>
            </div></form>
          </Box>
